...
import model.Entidades.userlogin;
...
public class LoginConexion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String id = user.getEmail();//request.getParameter("email");
            String Clave = user.getPassword();//request.getParameter("clave");      
            UsuarioDao objUsuario = new UsuarioDao();
            String idUser = objUsuario.verificar_usuario(id, Clave);
