...
public class UsuarioDao {
    ...
    public String verificar_usuario(String email, String password) throws SQLException {
        String idUser = "";
        try {
     ...
     public String EncontrarElId(String email) throws SQLException{
        String idUser="";
         try{
          PreparedStatement Consulta = conect.prepareCall("{call USP_SELECT_ID (?)}");
